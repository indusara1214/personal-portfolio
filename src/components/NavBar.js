        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#skills" className={activeLink === 'skills' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('skills')}>Education</Nav.Link>
            ...
            <span className="navbar-text">
              ...
              <a href="https://github.com/indusara1214" target="_blank" rel="noopener noreferrer"> <img src={navIcon3} alt="" /></a>
